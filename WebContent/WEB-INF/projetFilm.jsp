						...
						<div class="row">
							<div class="4u 12u(mobile)">
								<section class="box style1">
									...
									<h1><font color="black">Italie</font></h1>
								</section>
							</div>
							<div class="4u 12u(mobile)">
								<section class="box style1">
									...
									<h1><font color="black">4 projets créés</font></h1>
								</section>
							</div>
							<div class="4u 12u(mobile)">
								<section class="box style1">
									...
									<h1><font color="black">5 projets soutenus</font></h1>
								</section>
							</div>
							<div class="container">
							  <div class="col-sm-10 col-sm-offset-1">
							    <div class="page-header text-center">
							      <h1>20 jours restants</h1>
							    </div>
							    
							    <p class="lead text-center"> 
									599 € collectés sur un objectif de 15 222 €
							    </p> 					    
							  </div>
							</div>
						</div>
